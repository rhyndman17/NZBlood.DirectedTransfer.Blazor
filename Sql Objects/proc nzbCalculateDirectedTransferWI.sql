...
/****** Object:  StoredProcedure [dbo].[nzbCalculateDirectedTransferWI]    Script Date: 23-Oct-24 11:56:55 AM ******/
DROP PROCEDURE [dbo].[nzbCalculateDirectedTransferWI]
GO
...
CREATE proc [dbo].[nzbCalculateDirectedTransferWI] @pickFromSiteId varchar(20),@pouSiteId varchar(15) as
